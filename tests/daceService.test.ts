...
import { formatGradeTable, isClosedInscriptionHtml, isPdfBuffer } from "../src/services/daceService.js";

test("detecta el estado cerrado y no confunde otro HTML con cerrado", () => {
  assert.equal(isClosedInscriptionHtml("<p>No hay ningún proceso de inscripción activo para INGENIERIA.</p>"), true);
